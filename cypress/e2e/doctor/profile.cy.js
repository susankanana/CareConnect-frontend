...
describe('Admin Profile Update E2E Test', () => {
  beforeEach(() => {
    cy.loginAsDoctor();
    cy.visit('/doctor/dashboard/profile');
  });

  it('should update the doctor profile via the UI', () => {
    // Wait for profile data to load
    cy.contains('Dr.').should('exist');
    ...
    cy.contains('Dr. TestFirst TestLast').should('exist');
  });
});
