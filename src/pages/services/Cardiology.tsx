        ...
        <div className="p-8 md:p-12 lg:p-16 space-y-12">
          ...
          <div className="text-center mt-16 bg-gradient-to-r from-teal-50 to-pink-50 p-8 rounded-2xl shadow-inner">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto">
              Cardiology is a constantly evolving field, driven by ongoing research and
              technological innovations that continue to enhance our understanding and treatment of
              heart diseases. It stands as a cornerstone of modern healthcare, dedicated to
              protecting the organ that keeps us all going.
            </p>
          </div>
        </div>
      </div>
