    ...
    sections: [
      {
        ...
        icon: <Eye size={24} />,
        paragraphs: [
          'Ophthalmology deals with the anatomy, physiology, and diseases of the eye. Our specialists provide comprehensive care, from vision correction to advanced microsurgery.',
        ],
        features: [
          '**Cataract Surgery:** Replacing clouded lenses with high-performance implants.',
          '**Glaucoma Management:** Early detection and pressure control to save sight.',
          '**Retinal Care:** Managing diabetic retinopathy and macular degeneration.',
          '**Refractive Solutions:** Correcting Myopia and Astigmatism with precision.',
        ],
      },
      {
        ...
        paragraphs: [
          'We utilize state-of-the-art imaging to detect subtle ocular changes before they impact your vision.',
        ],
        features: [
          '**OCT Imaging:** High-definition cross-sections of the retina.',
          '**Visual Field Testing:** Mapping peripheral vision for glaucoma monitoring.',
          '**Corneal Topography:** Precise mapping for LASIK and contact lens fitting.',
          '**Tonometry:** Instant and accurate intraocular pressure measurement.',
        ],
      },
    ],
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#003d3d]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white font-black uppercase tracking-widest text-xs">Calibrating Visual Systems</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="hidden lg:block bg-white/5 p-8 rounded-[40px] border border-white/10 backdrop-blur-sm">
              <Eye size={64} className="text-[#00a18e] animate-pulse" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-10 pb-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {service.features && (
              <div className="bg-white rounded-[40px] shadow-2xl shadow-gray-200/50 p-8 md:p-12 border border-gray-100">
                <h2 className="text-2xl font-black text-[#003d3d] uppercase tracking-tight mb-8 flex items-center gap-3">
                  <div className="bg-teal-50 p-2 rounded-xl text-[#00a18e]"><Sparkles size={20}/></div>
            ...
            {exhaustiveOphthalmologyContent.sections.map((section, idx) => (
          ...
          <div className="space-y-8">
            <div className="bg-[#f43f8e] rounded-[40px] p-10 text-white shadow-2xl shadow-pink-200 sticky top-24">
              ...
              <h3 className="text-3xl font-black uppercase tracking-tighter mb-4">Restore Your Vision</h3>
              <p className="text-pink-100 font-medium mb-8">
                From basic checkups to advanced laser surgery, we help you see the world clearly.
              </p>
            ...
            <div className="bg-[#003d3d] rounded-[40px] p-10 text-white overflow-hidden relative">
              ...
              <h4 className="text-xs font-black uppercase tracking-[0.3em] text-[#00a18e] mb-2">Technology</h4>
              <p className="text-xl font-bold italic mb-0">Micro-Surgical Precision</p>
              <p className="text-3xl font-black mt-2">LASIK & OCT Ready</p>
            </div>
          </div>
