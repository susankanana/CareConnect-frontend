...
const DoctorAnalytics = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, isCurrency = false }: any) => (
    <div className="bg-white rounded-4xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
        <div>
          ...
          <p className="text-gray-400 font-medium">
            Welcome back, Dr. {user?.first_name}. Your practice is up 12% this month.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-sm">
          <div className="flex justify-between items-center mb-10">
            <h3 className="text-xl font-black italic text-gray-900 lowercase tracking-tight">
              revenue stream
            </h3>
        ...
        <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-sm flex flex-col items-center">
          <h3 className="text-xl font-black italic text-gray-900 mb-10 self-start lowercase tracking-tight">
            status mix
          </h3>
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie
                data={processedData.statusDist}
                innerRadius={60}
                outerRadius={85}
                paddingAngle={8}
                dataKey="value"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-sm">
          <h3 className="text-xl font-black italic text-gray-900 mb-8 lowercase tracking-tight">
            priority patients
          </h3>
          <div className="space-y-4">
            {processedData.topPatients.map((patient: any, i: number) => (
              <div
                key={i}
                className="flex items-center justify-between p-4 rounded-3xl bg-gray-50 hover:bg-teal-50 transition-colors group"
              >
        ...
        <div className="bg-linear-to-br from-[#003333] to-[#004d4d] rounded-[2.5rem] p-10 text-white flex flex-col justify-center">
          <Award className="text-pink-500 mb-6" size={40} />
          <h3 className="text-3xl font-black italic lowercase mb-4 leading-tight">
            manage your <br />
            medical practice
          </h3>
          <p className="text-teal-100/60 text-sm font-medium mb-10 leading-relaxed">
            Optimize your clinic performance by generating deep-dive reports or reviewing your
