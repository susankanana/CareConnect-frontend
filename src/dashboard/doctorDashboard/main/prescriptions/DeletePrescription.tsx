                ...
                {prescription && (
                    <div className="space-y-4 mb-6">
                        <p className="text-gray-700 font-medium">
                            Are you sure you want to delete this prescription? This action cannot be undone and will affect the appointment's total amount.
                        </p>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm">
                                    <span className="font-medium">Prescription ID:</span> #{prescription.prescriptionId}
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm">
                                    <span className="font-medium">Amount:</span> KSh {parseFloat(prescription.amount).toFixed(2)}
                                </span>
                            </div>
