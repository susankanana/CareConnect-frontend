...
import { Users as UsersIcon, Mail, Shield, CheckCircle, XCircle, Settings, UserCheck, UserX, Crown, User } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            {usersData && usersData.length > 0 ? (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border ${getRoleBadgeColor(user.role || 'user')}`}>
                ...
                <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-12 text-center">
                    ...
                    <p className="text-gray-600">Users will appear here once they register for your car rental service</p>
                </div>
            )}
