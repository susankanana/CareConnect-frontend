      ...
      {doctorsData && doctorsData.data && doctorsData.data.length > 0 ? (
        ...
        <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Get started by adding your first medical professional
          </p>
          <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">
                {
                  new Set(doctorsData.data.map((doctor: TDoctor) => doctor.doctor.specialization))
                    .size
                }
              </div>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <div className="text-2xl font-bold text-gray-600">
                {(
                  doctorsData.data.reduce(
                    (avg: number, doctor: TDoctor) => avg + (doctor.doctor.rating || 0),
                    0
