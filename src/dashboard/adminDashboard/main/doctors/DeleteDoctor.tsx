        ...
        {doctor && (
          <div className="space-y-4 mb-6">
            <p className="text-gray-700 font-medium">
              Are you sure you want to delete this doctor? This action cannot be undone and will
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">
                  <span className="font-medium">Name:</span> Dr. {doctor.user.firstName}{' '}
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <p className="text-red-700 text-sm font-medium">
                ⚠️ Warning: This will also delete all appointments and prescriptions associated with
                this doctor.
              </p>
            </div>
          </div>
