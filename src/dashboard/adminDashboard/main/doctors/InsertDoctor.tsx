      ...
      <div className="modal-box bg-white w-full max-w-xs sm:max-w-lg mx-auto rounded-lg border border-gray-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div>
            ...
            />
            {errors.contactPhone && (
              <span className="text-sm text-red-600">{errors.contactPhone.message}</span>
            )}
          </div>
          ...
          <div>
            ...
            {errors.specialization && (
              <span className="text-sm text-red-600">{errors.specialization.message}</span>
            )}
          </div>
          ...
          <div>
            ...
            {errors.availableDays && (
              <span className="text-sm text-red-600">{errors.availableDays.message}</span>
            )}
          </div>
