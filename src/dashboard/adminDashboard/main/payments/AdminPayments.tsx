        ...
        <div className="bg-white p-4 rounded-2xl shadow flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-green-600">
              {' '}
              {formatAmount(revenueSummary.today.toString())}
            </p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-2xl shadow flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-blue-600">
              {' '}
              {formatAmount(revenueSummary.week.toString())}
            </p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-2xl shadow flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-purple-600">
              {' '}
              {formatAmount(revenueSummary.month.toString())}
            </p>
          </div>
        </div>
      </div>
                      ...
                      <tr key={payment.paymentId} className="hover:bg-gray-50 text-sm">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <span
                              className={`px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(payment.paymentStatus)}`}
                            >
