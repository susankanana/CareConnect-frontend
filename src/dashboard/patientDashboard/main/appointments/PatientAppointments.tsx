        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Your payment has been confirmed and your appointment is now secured. You will receive
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  {selectedAppointment.doctor?.name} {selectedAppointment.doctor?.lastName}
                </div>
                <div>
                ...
                <div>
                  <span className="font-medium">Amount Paid:</span> KSh{' '}
                  {parseFloat(selectedAppointment.totalAmount).toFixed(2)}
                </div>
                <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() =>
                  (
                    document.getElementById('create_appointment_modal') as HTMLDialogElement
                  )?.showModal()
                }
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              View your medical appointments - {appointmentsData?.data?.length || 0} total
              appointments
            </p>
          </div>
          <button
      ...
      {appointmentsData && appointmentsData.data && appointmentsData.data.length > 0 ? (
            ...
            >
              ...
              <div className="bg-gradient-to-r from-teal-50 to-pink-50 p-4 border-b">
                <div className="flex justify-between items-start">
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(appointment.status)}`}
                  >
        ...
        <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Book your first appointment with our medical professionals
          </p>
          <button
                ...
                {appointmentsData.data
                  .reduce(
                    (total: number, apt: TDetailedAppointment) =>
                      total + parseFloat(apt.totalAmount),
                    0
                  )
                  .toFixed(0)}
              </div>
