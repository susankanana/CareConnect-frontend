  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-400 font-medium tracking-tight">
            here is your wellness journey at a glance
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          title="health spend"
          value={processedData.overview.totalSpent}
          icon={CreditCard}
          isCurrency
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm">
          <h3 className="text-xl font-black italic text-gray-900 mb-10 lowercase tracking-tight">
            spending trajectory
          </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm">
          <h3 className="text-xl font-black italic mb-8 lowercase tracking-tight text-teal-600">
            recent history
          </h3>
        ...
        {/* Call to Action Card */}
        <div className="bg-linear-to-br from-[#004d4d] to-[#006666] rounded-[3rem] p-10 text-white relative overflow-hidden flex flex-col justify-center">
          ...
          <p className="text-teal-100/70 text-sm font-medium mb-10 leading-relaxed">
            your health data is your power. download your complete medical history or schedule your
            next check-up today.
          </p>
